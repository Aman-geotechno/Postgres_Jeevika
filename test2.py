...
CREATE TABLE m_pg (
   id SERIAL PRIMARY KEY,
   amount_send_to_pg DECIMAL(10, 2),
   formation_date DATE,
   pg_id INTEGER,
...
CREATE TABLE pg_non_pg_members (
   id SERIAL PRIMARY KEY,
   updated_on TIMESTAMP,
   created_on TIMESTAMP,
   block_id INTEGER,
   ...
   member_id INTEGER,
   updated_by INTEGER,
   jeevika_non_jeevika VARCHAR(50),
   shankul_sandh_name VARCHAR(255),
   group_name VARCHAR(255),
   group_didi_name VARCHAR(255),
   licence_number VARCHAR(50),
   aadhaar_number VARCHAR(20),
   shg_member_name VARCHAR(255),
   gram_sangathan_name VARCHAR(255),
   is_active BOOLEAN,
   is_sjy_beneficiary BOOLEAN,
   district_id INTEGER,
   district_name VARCHAR(255)
);
CREATE TABLE m_clcdc (
   clcdc_id SERIAL PRIMARY KEY,
   clf_id INTEGER,
   file_1 VARCHAR(255),
   file_2 VARCHAR(255),
   file_3 VARCHAR(255),
   created_date DATE,
   clcdc_name VARCHAR(255),
   address VARCHAR(255),
   pin VARCHAR(10),
   email VARCHAR(255),
   mobile VARCHAR(20),
   ...
   block_id INTEGER,
   created_by INTEGER,
   clf_name VARCHAR(255)
);
CREATE TABLE t_vidya_didi (
   id SERIAL PRIMARY KEY,
   clf_id INTEGER,
   education_certificate_pic VARCHAR(255),
   shg_id INTEGER,
   experience_certificate_pic VARCHAR(255),
   applicant_dob DATE,
   aadhar_pic VARCHAR(255),
   applicant_doj DATE,
   saving_account_pic VARCHAR(255),
   others_noneducation_certificate_pic VARCHAR(255),
   vo_id INTEGER,
   month INTEGER,
   year INTEGER,
   vidya_didi_pic VARCHAR(255),
   ...
   nishakt_id INTEGER,
   nishakt VARCHAR(255),
   nishakta_type VARCHAR(50),
   temp_house_road_name_no VARCHAR(255),
   temp_village_name VARCHAR(255),
   temp_prakhand VARCHAR(255),
   temp_jila VARCHAR(255),
   temp_state VARCHAR(255),
   temp_pin VARCHAR(10),
   per_house_road_name_no VARCHAR(255),
   per_vill_city VARCHAR(255),
   per_prakhand VARCHAR(255),
   per_jila VARCHAR(255),
   per_state VARCHAR(255),
   per_pin VARCHAR(10),
   vidya_didi_pic_name VARCHAR(255),
   education_certificate_pic_name VARCHAR(255),
   experience_certificate_pic_name VARCHAR(255),
   aadhar_pic_name VARCHAR(255),
   saving_account_pic_name VARCHAR(255),
   fy VARCHAR(10),
   created_by INTEGER,
   others_noneducation_certificate_pic_name VARCHAR(255),
   entry_id INTEGER,
   district_id INTEGER,
   district_name VARCHAR(255),
   block_id INTEGER,
   ...
   applicant_fname VARCHAR(255),
   phone VARCHAR(20)
);
CREATE TABLE t_learner_profile (
   student_dob DATE,
   month INTEGER,
   year INTEGER,
   created_date TIMESTAMP,
   ...
   admission_date DATE,
   is_active_update_date DATE,
   registration_no VARCHAR(50),
   student_caste_category VARCHAR(255),
   student_caste_category_id INTEGER,
   ...
   higher_qualification_id INTEGER,
   higher_qualification VARCHAR(255),
   clf_id INTEGER,
   clf_name VARCHAR(255),
   vo_id INTEGER,
   vo_name VARCHAR(255),
   shg_id INTEGER,
   shg_name VARCHAR(255),
   seva_option_a VARCHAR(255),
   seva_option_a_name VARCHAR(255),
   seva_option_b VARCHAR(255),
   seva_option_b_name VARCHAR(255),
   seva_option_c VARCHAR(255),
   seva_option_c_name VARCHAR(255),
   seva_option_d VARCHAR(255),
   seva_option_d_name VARCHAR(255),
   seva_option_e VARCHAR(255),
   seva_option_e_name VARCHAR(255),
   seva_option_f VARCHAR(255),
   seva_option_f_name VARCHAR(255),
   seva_option_g VARCHAR(255),
   seva_option_g_name VARCHAR(255),
   seva_option_h VARCHAR(255),
   seva_option_h_name VARCHAR(255),
   seva_option_i VARCHAR(255),
   seva_option_i_name VARCHAR(255),
   seva_option_j VARCHAR(255),
   seva_option_j_name VARCHAR(255),
   seva_option_k VARCHAR(255),
   seva_option_k_name VARCHAR(255),
   seva_option_l VARCHAR(255),
   seva_option_l_name VARCHAR(255),
   seva_option_m VARCHAR(255),
   seva_option_m_name VARCHAR(255),
   fy VARCHAR(10),
   created_by INTEGER,
   is_active BOOLEAN,
   is_active_update_by INTEGER,
   entry_id INTEGER,
   student_name VARCHAR(255),
   student_pic_name VARCHAR(255),
   student_m_name VARCHAR(255),
   student_f_name VARCHAR(255),
   student_gender VARCHAR(20),
   student_gender_id INTEGER
);
